            ...
            switch (selMenu) {
                case 1:
                    ...
                    for (String name : map.keySet()) {
                        System.out.println("메뉴 : " + map.get(name).getName());
                        System.out.println("가격 : " + map.get(name).getPrice());
                        System.out.println("분류 : " + map.get(name).getCategory());
                        System.out.println("설명 : " + map.get(name).getDesc());
                        System.out.println("------------------------------");
                    }
                    break;
                case 2:
                ...
                case 4:
                    ...
                    if (map.containsKey(key)) {
                        map.remove(key);
                        System.out.print(key + " 메뉴를 삭제 하였습니다.");
                    } else {
